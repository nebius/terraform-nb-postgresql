...
resource "nebius_mdb_postgresql_user" "owner" {
...
resource "nebius_mdb_postgresql_user" "user" {
  ...
  dynamic "permission" {
    ...
    content {
      database_name = nebius_mdb_postgresql_database.database[permission.value].name
    }
  }
}
