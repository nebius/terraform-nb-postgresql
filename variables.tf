...
variable "folder_id" {
  description = "nebius Cloud Folder ID where the cluster resides"
  type        = string
  default     = null
}
...
variable "postgresql_config" {
  description = <<EOF
    ...
    Link: https://registry.terraform.io/providers/nebius-cloud/nebius/latest/docs/resources/mdb_postgresql_cluster#postgresql-cluster-settings
  EOF
  type        = map(any)
  default     = null
}
...
variable "default_user_settings" {
  description = <<EOF
    ...
    Full description https://cloud.nebius.com/en-ru/docs/managed-postgresql/api-ref/grpc/user_service#UserSettings1
  EOF
  type        = map(any)
  default     = {}
}
