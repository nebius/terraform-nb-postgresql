# Nebius Cloud Managed PostgreSQL Cluster
...
| <a name="provider_nebius"></a> [nebius](#provider\_nebius) | > 0.8.3 |
...
| [nebius_mdb_postgresql_cluster.this](https://registry.terraform.io/providers/nebius-cloud/nebius/latest/docs/resources/mdb_postgresql_cluster) | resource |
| [nebius_mdb_postgresql_database.database](https://registry.terraform.io/providers/nebius-cloud/nebius/latest/docs/resources/mdb_postgresql_database) | resource |
| [nebius_mdb_postgresql_user.owner](https://registry.terraform.io/providers/nebius-cloud/nebius/latest/docs/resources/mdb_postgresql_user) | resource |
| [nebius_mdb_postgresql_user.user](https://registry.terraform.io/providers/nebius-cloud/nebius/latest/docs/resources/mdb_postgresql_user) | resource |
| [nebius_client_config.client](https://registry.terraform.io/providers/nebius-cloud/nebius/latest/docs/data-sources/datasource_client_config) | data source |
...
| <a name="input_default_user_settings"></a> [default\_user\_settings](#input\_default\_user\_settings) | The default user settings. These settings are overridden by the user's settings.<br>    Full description https://cloud.nebius.com/en-ru/docs/managed-postgresql/api-ref/grpc/user_service#UserSettings1 | `map(any)` | `{}` | no |
...
| <a name="input_postgresql_config"></a> [postgresql\_config](#input\_postgresql\_config) | A map of PostgreSQL cluster configuration.<br>    Details info in a 'PostgreSQL cluster settings' of official documentation.<br>    Link: https://registry.terraform.io/providers/nebius-cloud/nebius/latest/docs/resources/mdb_postgresql_cluster#postgresql-cluster-settings | `map(any)` | `null` | no |
